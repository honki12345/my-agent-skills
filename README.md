...
| Skill | 설명 | 트리거 | 생성일 |
|-------|------|--------|--------|
| `gh-review-triage` | PR 링크 기반 리뷰 코멘트 반영 여부 판단 + 근거 + 반영 방법 제시 | PR 링크로 리뷰 코멘트 판정을 요청할 때 | 2026-02-15 |
...
| `plan-review` | 구현 계획 문서 6관점 순차 요약 리뷰(테스트 계획 현실성/커버리지 포함) + 사용자 선택 즉시 반영 + 반복 루프 | `/plan-review` 수동 호출 | 2026-02-14 |
